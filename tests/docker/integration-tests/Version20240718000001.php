 ...
 */
class Version20240718000001 implements ISqlMigration
{
    public function sql(IDBConnection $connection)
    {
        $stmt = $connection->prepare("
        # email is needed for invitation
        UPDATE `oc_accounts` SET email='admin@oc-1.nl' WHERE user_id='admin';
        ...
        ('collaboration',	'endpoint',	'https://oc-1.nl/apps/collaboration')
