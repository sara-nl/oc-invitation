...
<body>
    ...
    <div class="wayf">
        ...
        <div class="institutes">
            ...
            print_r('<p><a href="' . $item['handleInviteUrl'] . '">Miskatonic University</a></p>');
            print_r('<p><a href="' . $item['handleInviteUrl'] . '">Aperture Laboratories</a></p>');
            print_r('<p><a href="' . $item['handleInviteUrl'] . '">Radius High School</a></p>');
            ?>
        </div>
    </div>
</body>
